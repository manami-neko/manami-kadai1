            ...
            <div class="contact-form__group">
                ...
                <div class="checkbox">
                    <div class="form__input--text">
                        ...
                        <label>
                            <input type="checkbox" name="channel_ids[]" value="{{ $channel->id }}">{{ $channel->content }}
                        </label>
                        @endforeach
                    </div>
                    <div class="form__error">
            ...
            <div class="contact-form__group">
                ...
                <div class="form__group-content">
                    <div class="form__input--textarea">
                        <input type="textarea" name="detail" value="{{ old('detail') }}" placeholder="お問い合わせ内容をご記載ください"></input>
                    </div>
                    <div class="form__error">
                        @error('detail')
                        {{ $message }}
